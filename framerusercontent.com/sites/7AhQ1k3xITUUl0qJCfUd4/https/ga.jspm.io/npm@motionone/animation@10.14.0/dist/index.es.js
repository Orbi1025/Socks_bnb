...
import { cubicBezier as h, steps as o } from "@motionone/easing";
const l = {
...
function getEasingFunction(s) {
  ...
  if (s.startsWith("steps")) {
    ...
    if (t) {
      const i = t[1].split(",");
      return o(parseFloat(i[0]), i[1].trim());
    }
  }
  return e;
}
class Animation {
  constructor(
    ...
    h = h || s.easing;
    if (a(h)) {
      const t = h.createAnimation(i);
      h = t.easing;
      i = t.keyframes || i;
      o = t.duration || o;
    }
    this.repeat = m;
    this.easing = n(h) ? e : getEasingFunction(h);
    this.updateDuration(o);
    const d = r(i, c, n(h) ? h.map(getEasingFunction) : e);
    this.tick = (i) => {
      var e;
      l = l;
      let s = 0;
      ...
      ("reverse" === p ||
        ("alternate" === p && h) ||
        ("alternate-reverse" === p && !h)) &&
        (r = 1 - r);
      const o = s >= this.totalDuration ? 1 : Math.min(r, 1);
      const m = d(this.easing(o));
      t(m);
      const c =
        void 0 === this.pauseTime &&
        ("finished" === this.playState || s >= this.totalDuration + u);
      if (c) {
        this.playState = "finished";
        null === (e = this.resolve) || void 0 === e ? void 0 : e.call(this, m);
      } else
        "idle" !== this.playState &&
